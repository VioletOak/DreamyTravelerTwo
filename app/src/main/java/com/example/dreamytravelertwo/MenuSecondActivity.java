...
public class MenuSecondActivity extends AppCompatActivity {
    ...
    private void setInitialData() {
        cities.add( new MenuCity("Париж", "Франция, регион Иль-де-Франс", R.drawable.menu_paris,
        ...
        cities.add( new MenuCity("Нью-Йорк", " США, штат Нью-Йорк", R.drawable.menu_new_york,
        ...
        cities.add( new MenuCity("Токио", "Япония, о. Хонсю", R.drawable.menu_tokyo,
        ...
        cities.add( new MenuCity("Рим", "Италия, регион Лацио", R.drawable.menu_rome,
        ...
        cities.add( new MenuCity("Сидней", "Австралия, Новый Южный Уэльс", R.drawable.menu_ydney,
        ...
        cities.add( new MenuCity("Санкт-Петербург", "Россия, Северо-Западный федеральный округ",
                R.drawable.menu_saint_petersburg,
